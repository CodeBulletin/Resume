const theme_button = document.getElementsByClassName("theme")[0]
let dark_img = Array.from(document.querySelectorAll(".img_dark") )
let light_img = document.querySelectorAll(".img_light") 
let print_img = document.querySelectorAll(".img_print") 
